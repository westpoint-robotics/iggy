...
if (len(sys.argv) > 3):
    ...
    folderOfBagFiles=os.getcwd()+"/"
    print "Folder of bag files is:",folderOfBagFiles
...
for bagFile in listOfBagFiles:
    ...
    #access bag
    if (len(sys.argv) >= 2):
        bag = rosbag.Bag("./"+folderOfBagFiles + bagFile)
    ...
    try:    #else already exists
        os.makedirs("./"+folderOfBagFiles + folder)
    except:
        pass
    shutil.copyfile(folderOfBagFiles + bagName, "./"+folderOfBagFiles + folder + '/' + bagName)
    ...
    for topicName in listOfTopics:
        ...
        filename = folderOfBagFiles + folder + topicName + '.csv'
