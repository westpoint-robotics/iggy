...
#ifndef GAZEBO_IGGY_VISION_HH
#define GAZEBO_IGGY_VISION_HH
...
namespace gazebo
{
  class GazeboIggyVision : public DepthCameraPlugin, GazeboRosCameraUtils
  {
    /// \brief Constructor
    /// \param parent The parent entity, must be a Model or a Sensor
    public: GazeboIggyVision();
    ...
    /// \brief Detect white lines    ===========================================================
    private: WhitelineFilter wl_filter; 
    private: cv::Mat cvinit_image;
    private: void DetectWhiteLines(const unsigned char *_image,
                   unsigned int _width, unsigned int _height,
                   unsigned int _depth, const std::string &_format);

private: bool WhiteLineTester();
    ...
    private: bool FillPointCloudHelperWhiteAlt(sensor_msgs::PointCloud2 &point_cloud_msg,
                                  uint32_t rows_arg, uint32_t cols_arg,
                                  uint32_t step_arg, void* data_arg);

    private: bool FillPointCloudHelperWhite(sensor_msgs::PointCloud2 &point_cloud_msg,
                                  uint32_t rows_arg, uint32_t cols_arg,
                                  uint32_t step_arg, void* data_arg);
